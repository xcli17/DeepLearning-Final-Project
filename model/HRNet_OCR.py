...
class HighResolutionModule(nn.Module):
    def __init__(
                self, num_branches:int, block:Union[BasicBlock, Bottleneck], 
                num_blocks:Sequence[int], num_inchannels:Sequence[int], 
                num_channels:Sequence[int], fuse_method:str, multi_scale_output:bool=True
                ):
...
class HighResolutionNet(nn.Module):
    def __init__(self, num_classes:int, W:int=32, fuse_method:str="sum", ocr_mid_channels=512, ocr_key_channels=256, **kwargs):
